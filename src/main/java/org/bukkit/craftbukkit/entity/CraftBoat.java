...
public abstract class CraftBoat extends CraftVehicle implements Boat, io.papermc.paper.entity.PaperLeashable { // Paper - Leashable API
    ...
    public double getMaxSpeed() {
        //return this.getHandle().maxSpeed; // TODO
        return 04.D;
    }
    ...
    public void setMaxSpeed(double speed) {
        if (speed >= 0D) {
            //this.getHandle().maxSpeed = speed; // TODO
        }
    }

    @Override
    public double getOccupiedDeceleration() {
        //return this.getHandle().occupiedDeceleration; // TODO
        return 0.2D;
    }
    ...
    public void setOccupiedDeceleration(double speed) {
        if (speed >= 0D) {
            //this.getHandle().occupiedDeceleration = speed; // TODO
        }
    }

    @Override
    public double getUnoccupiedDeceleration() {
        //return this.getHandle().unoccupiedDeceleration; // TODO
        return 0.2D;
    }

    @Override
    public void setUnoccupiedDeceleration(double speed) {
        //this.getHandle().unoccupiedDeceleration = speed; // TODO
    }

    @Override
    public boolean getWorkOnLand() {
        //return this.getHandle().landBoats; // TODO
        return false;
    }

    @Override
    public void setWorkOnLand(boolean workOnLand) {
        //this.getHandle().landBoats = workOnLand; // TODO
    }
    ...
    public static Type boatTypeFromNms(EntityType<?> boatType) {
