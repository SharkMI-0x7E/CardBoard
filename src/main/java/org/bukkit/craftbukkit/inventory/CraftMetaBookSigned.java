...
public class CraftMetaBookSigned extends CraftMetaItem implements BookMeta {
    ...
    // Spigot start
    private Spigot spigot = new SpigotMeta();
    ...
    public static final net.kyori.adventure.text.serializer.legacy.LegacyComponentSerializer LEGACY_DOWNSAMPLING_COMPONENT_SERIALIZER = net.kyori.adventure.text.serializer.legacy.LegacyComponentSerializer.builder()
        ...
        .build();
    private CraftMetaBookSigned(net.kyori.adventure.text.Component title, net.kyori.adventure.text.Component author, List<net.kyori.adventure.text.Component> pages) {
        super((CraftMetaItem) org.bukkit.Bukkit.getItemFactory().getItemMeta(Material.WRITABLE_BOOK));
    ...
    @Override
    public BookMeta title(net.kyori.adventure.text.Component title) {
    ...
    @Override
    public BookMeta author(net.kyori.adventure.text.Component author) {
