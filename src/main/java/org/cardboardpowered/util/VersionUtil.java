...
public final class VersionUtil {
    ...
    public static SupportStatus getServerSupportStatus() {
        if (supportStatus == null) {
            ...
            return supportStatus = /*PaperLib.isPaper()*/ true ? SupportStatus.FULL : SupportStatus.LIMITED;
        }
    ...
    public static final class BukkitVersion implements Comparable<BukkitVersion> {
        ...
        public boolean isHigherThanOrEqualTo(final BukkitVersion o) {
        	...
        	// Wait till we update our paper-api to 1.20.4
        	//	- cardboard
        	//if (o == VersionUtil.v1_20_6_R01) {
        	//	return false;
        	//}
        	
        	/*
        	if (o == VersionUtil.v1_21_R01) {
        		return false;
        	}
        	
        	if (o == VersionUtil.v1_21_1_R01) {
        		return false;
        	}
        	*/
